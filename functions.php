...
function add_custom_scripts() {
  ...
  wp_enqueue_script( 'typed', get_stylesheet_directory_uri() . '/inc/assets/js/typed.min.js', array('jquery'), true );
  wp_enqueue_script( 'typed-custom', get_stylesheet_directory_uri() . '/inc/assets/js/typed-custom.js', array('jquery'), true );
  }
...
if( function_exists('acf_add_options_page') ) {
	...
	acf_add_options_page(array(
		'page_title' 	=> 'Allmänna Inställningar',
		'menu_title'	=> 'Allmänna Inställningar',
		'menu_slug' 	=> 'allmanna-installningar',
		'capability'	=> 'edit_posts',
		'redirect'		=> false
	));
	
	acf_add_options_sub_page(array(
		'page_title' 	=> '404 Sida Inställningar',
		'menu_title'	=> '404',
		'parent_slug'	=> 'allmanna-installningar',
	));

	acf_add_options_sub_page(array(
		'page_title' 	=> 'Bli Medlem Inställningar',
		'menu_title'	=> 'Bli Medlem',
		'parent_slug'	=> 'allmanna-installningar',
	));
	
	acf_add_options_sub_page(array(
		'page_title' 	=> 'Mål Navigation Inställningar',
		'menu_title'	=> 'Mål: Navigation',
		'parent_slug'	=> 'allmanna-installningar',
	));
	
	acf_add_options_sub_page(array(
		'page_title' 	=> 'Sidfot Inställningar',
		'menu_title'	=> 'Sidfot',
		'parent_slug'	=> 'allmanna-installningar',
	));
...
/**
 * Default from WP-Bootstrap Starter
 *
 */
